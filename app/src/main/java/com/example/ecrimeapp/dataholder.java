...
{
  String name,contact,pimage,address,criminaltype,previousrecord,habits,remaddate ;

    public dataholder(String name, String contact, String address,String criminaltype,String previousrecord,String habits,String remaddate, String pimage) {
